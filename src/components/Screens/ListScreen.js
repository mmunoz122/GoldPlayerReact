    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      <header
        style={{
          ...
          left: 0,
          width: '100%',
          height: '100px', // Alçada fixa del header
          padding: '10px',
      ...
      <main
        style={{
          flex: 1,
          paddingTop: '120px', // Espai per ajustar amb el header
          paddingBottom: '60px', // Espai per ajustar amb el footer
          padding:'580px',
      ...
      >
        <h3 style={{ color: '#fff' , width: '200%'}}>Selecciona una llista per veure els vídeos:</h3>
      ...
      <footer
        style={{
          ...
          left: 0,
          width: '100%',
          height: '70px', // Alçada fixa del footer
          backgroundColor: '#8e44ad',
          display: 'flex',
